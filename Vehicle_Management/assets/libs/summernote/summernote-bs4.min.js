        ...
        qt = function () {
            ...
            return t.prototype.initialize = function () {
                ...
                if (e && e.items && e.items.length) {
                    ...
                    "file" === o.kind && -1 !== o.type.indexOf("image/index.html") && this.context.invoke("editor.insertImagesOrCallback", [o.getAsFile()]), this.context.invoke("editor.afterCommand")
                }
            }, t
        }(),
        Kt = function () {
    ...
    var Vt = function () {
        ...
        Xt = function () {
            ...
            return t.prototype.representShortcut = function (t) {
                ...
                return this.options.shortcuts && e ? (z.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "https://coderthemes.com/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
